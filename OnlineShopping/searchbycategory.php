	  ...
	  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 border">
			<ul class="list-group">
                ...
                <?php foreach($resultcat as $row) {?>
                            ...
                            <a href="searchbycategory.php?cat=<?php echo $row['Category_ID'] ?>"  style="text-decoration:none;">
      	...
      	<div class="row  border max-auto"> 
      		...
      		<div class="col-4  border ">
                ...
                <button type="button" class="btn btn-primary">
                 	<a href="addtocart.php?id=<?php echo $row['Product_ID'] ?>" style="text-decoration:none;color:white;">
                  Add to Cart</a>
               	</button>
